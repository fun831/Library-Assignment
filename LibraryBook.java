...
/**
 * Class representation of a library book. The ISBN, author, and title can 
 * never change once the book is created. Book is the base class of the 
 * library book class. Includes a method for checking in and out a book,
 * sets a due date, and sets a holder of the book. 
 * 
...
public class LibraryBook extends Book {
	...
	/**
	 * Constructor of a Library Book object. Sets the isbn, the author, and
	...
	/**
	 * Checks in the book setting the holder and due date to
	 * null.
	 */
	public void checkIn() {
		holder = null;
